...
export const DashboardBase: React.FC<{ children: React.ReactNode, activeTab: string }> = ({ children, activeTab }) => <div className="h-screen w-screen flex bg-slate-800 justify-center">
    <div className="w-full h-full max-w-4xl flex flex-col items-center">
        <div className="w-full h-20 items-center flex p-4">
            ...
            <Link className={`${activeTab == "dashboard" ? 'bg-gray-600/20' : ""} px-6 py-2 rounded-lg text-center ml-4`} href="/dashboard">
                <h1 className="text-purple-50/90">Dashboard</h1>
            </Link>
            <Link className={`${activeTab == "apps" ? 'bg-gray-600/20' : ""} px-6 py-2 rounded-lg text-center ml-4`} href="/apps">
                <h1 className="text-purple-50/90">Apps</h1>
            </Link>
            <Link className={`${activeTab == "account" ? 'bg-gray-600/20' : ""} px-6 py-2 rounded-lg text-center ml-4`} href="/account">
